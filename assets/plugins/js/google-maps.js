    ...
    $(".map-canvas").each(function () {
      ...
      if (iconPath) {
        map.addMarker({
          ...
          infoWindow: {
            content:
              '<img src="./assets/images/ongoing-project-map/1.png" alt="fp1.jpg"/> <h4>BuildUp Lake View Haven - Mohakhali DOSH</h4> <p><i class="fi fi-sr-land-layer-location"></i>Mohakhali DOSH, Dhaka, Bangladesh</p><a href="project-details.html">View project<i class="fi-rr-arrow-right"></i></a>',
          },
        });
        map.addMarker({
          icon: iconPath,
